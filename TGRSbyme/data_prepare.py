...
def construct_H_with_KNN_from_distance(dis_mat, k_neig, is_probH=True, m_prob=1, sig=0.002):
    """
...
def data_prepare(num_class):
    ...
    # np.save('./Datasets/IndianPines/data_py/gt_train.npy', gt_train)
    # np.save('./Datasets/IndianPines/data_py/gt_test.npy', gt_test)
    # np.save('./Datasets/IndianPines/data_py/img_train.npy', img_train)
    # np.save('./Datasets/IndianPines/data_py/img_test.npy', img_test)

def data_prepare_whole(num_class, variable_weight = False, k_spe = 10, k_spa = 10):
    #data_prepare
    img = scio.loadmat('./Datasets/IndianPines/Indian_pines_corrected.mat')['indian_pines_corrected']
    gt = scio.loadmat('./Datasets/IndianPines/Indian_pines_gt.mat')['indian_pines_gt']
